...
class lsg_scan_phase(LightShiftGate_TTL):
...
class LightShiftGateScanPhaseTTL(pulse_sequence):
    
    scannable_params = {'LightShift.duration': [(0.0001, 0.5, 0.02, 'ms') ,'starkshift'],}
