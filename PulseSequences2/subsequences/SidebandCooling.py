...
class SidebandCooling(pulse_sequence):
    ...
    def sequence(self):
        ...
        # Short repumper pulse with max power to emptythe D state 
        # self.addDDS('854dp', self.start + duration, repump_additional, sc.sideband_cooling_frequency_854 , U(-5, 'dBm')) # EP
