...
# class CalibrationDataModel(QtCore.QAbstractTableModel): 

#     def __init__(self):
#         super(CalibrationDataModel, self).__init__()
        
#     def loadModel(self, experiments):        
#         data = []
#         for exp in experiments:
#             data.append([exp, 0, 'Normal', False])
#         self._data = data
...
# class calibrations_dialog(QtGui.QDialog):
#     def __init__(self, model):
#         super(calibrations_dialog, self).__init__()
#         self._model = model
#         self.setWindowTitle('Schedule calibration routines')
#         self.setupLayout()
#         self.connect_layout()
...
class experiment_selector_widget(QtGui.QWidget):
    ...
    def setupLayout(self):
        ...
        #self.calibrations_button = QtGui.QPushButton("Calibrations") # *********************************
        ...
        #.addWidget(self.calibrations_button, 1, 4, 1, 1) # *********************************
        self.setLayout(layout)
    ...
    def connect_layout(self):
        ...
        #self.calibrations_button.pressed.connect(self.on_calibrations_button) # *********************************
    ...
    # def on_calibrations_button(self):
    #     model = CalibrationDataModel()
    #     model.loadModel(self.experiments)
    #     dialog = calibrations_dialog(model)
    #     if dialog.exec_():
    #         pass 
