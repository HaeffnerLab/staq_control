...
class ParameterVault(LabradServer):
    ...
    onParameterChange = Signal(612512, 'signal: parameter change', '(ss?)') # EP
...
#        yield self.load_parameters()
    ...
    def setParameter(self, c, collection, parameter_name, value, full_info = False):
        ...
        #self.onParameterChange((key[0], key[1]), notified) # OLD
        self.onParameterChange((key[0], key[1], self.parameters[key]), notified) #EP
