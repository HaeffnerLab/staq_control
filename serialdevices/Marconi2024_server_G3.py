...
#SERVERNAME = 'Marconi_2024_G3'
#SIGNALID = 190234 ## this needs to change


class Marconi_2024_G3(LabradServer):
    name = 'Marconi_2024_G3'
    instr = None
    ...
    def initServer(self):
        ...
        try:
            ...
            dev_path = '/dev/ttyUSB1'#(rm.list_resources()[0])[4:16]
