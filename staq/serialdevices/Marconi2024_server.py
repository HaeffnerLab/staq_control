...
#SERVERNAME = 'Marconi_2024'
#SIGNALID = 190234 ## this needs to change


class Marconi_2024(LabradServer):
    name = 'Marconi_2024'
    instr = None
    ...
    def initServer(self):
        ...
        try:
            ...
            dev_path = '/dev/ttyUSB0'#(rm.list_resources()[0])[4:16]
    ...
    def setMod(self,f):
        if f==True:
            msg =str(':MODE AM;:AM:DEPTH 99.9;INT;EXTDC;ON;')
            msg1 =str(':MOD:ON;')
        else:
            msg =str(':MOD:OFF;')
            msg1 =str(':AM:OFF;')
