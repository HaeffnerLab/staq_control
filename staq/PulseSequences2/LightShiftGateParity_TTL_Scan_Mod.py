...
import numpy as np
from LightShiftGateParity_TTL_Mod import LightShiftGateParity_TTL_Mod

class Light_Shift_Gate_Parity_TTL_Scan_Mod(LightShiftGateParity_TTL_Mod):
...
class LightShiftGateParityTTLScanMod(pulse_sequence):
    ...
    sequence = Light_Shift_Gate_Parity_TTL_Scan_Mod